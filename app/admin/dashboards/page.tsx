...
export default function AdminDashboardsPage() {
  ...
  const resetForm = () => {
    setFormData({ titre: "", description: "", urlPowerBI: "", secteurId: "" });
    setError("");
  };
    ...
    <>
      ...
      <div className="db-root">
        <div className="db-page-header">
          <h1 className="db-page-title">Gestion des dashboards</h1>
          <p className="db-page-sub">
            {dashboards.length} dashboard{dashboards.length > 1 ? "s" : ""} enregistré
          ...
          <table className="db-table">
            ...
            <tbody>
              {filteredDashboards.length === 0 ? (
                <tr>
                  <td colSpan={4} className="db-empty">Aucun dashboard trouvé.</td>
                </tr>
              ) : (
                filteredDashboards.map((d) => (
                  <tr key={d.id}>
                    ...
                    <td>
                      <span className="db-secteur-badge">{d.secteur.nom}</span>
                    </td>
                    <td>
                      <a
                        href={d.urlPowerBI}
                      ...
                      >
                        ...
                        {d.urlPowerBI.length > 40
                          ? d.urlPowerBI.substring(0, 40) + "..."
                          : d.urlPowerBI}
                      </a>
                    </td>
                    <td>
            ...
            <div className="db-modal">
              <div className="db-modal-header">
                ...
                <button
                  ...
                  onClick={() => { resetForm(); setShowAjoutModal(false); }}
                >
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
            ...
            <div className="db-modal">
              <div className="db-modal-header">
                <div className="db-modal-hl">
                  ...
                  <div>
                    <h2>Modifier le dashboard</h2>
                    <p>Mettez à jour les informations</p>
                  </div>
                </div>
                <button
                  className="db-modal-close"
                  onClick={() => { setShowModifierModal(false); setDashboardToEdit(null); resetForm(); }}
                >
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                    <path d="M18 6 6 18M6 6l12 12" />
                  </svg>
              ...
              <div className="db-modal-body">
                <div className="db-notice">
                  Modification de <strong>{dashboardToEdit.titre}</strong>
                </div>
                {error && <div className="db-error">{error}</div>}
        ...
        {showDeleteConfirm && (
          <div className="db-overlay">
            <div className="db-modal db-modal-sm">
              ...
              <h2 className="db-del-title">Confirmer la suppression</h2>
              <p className="db-del-text">
                Cette action est irréversible. Êtes-vous sûr de vouloir supprimer ce dashboard ?
              </p>
              <div className="db-modal-actions db-actions-center">
                <button
                  className="db-btn-cancel"
                  onClick={() => { setShowDeleteConfirm(false); setDashboardToDelete(null); }}
                >
                  Annuler
                </button>
                <button className="db-btn-confirm-del" onClick={handleDelete}>
    ...
    <>
      ...
      <div className="db-group">
        <label className="db-label">
          Description <span className="db-label-opt">(optionnel)</span>
        </label>
        <textarea
      ...
      <div className="db-group">
        ...
        <div className="db-input-wrap">
          ...
          <input
            ...
            onChange={(e) => setFormData({ ...formData, urlPowerBI: e.target.value })}
            required
          />
        </div>
      </div>
      ...
      <div className="db-group">
        ...
        <div className="db-select-wrap">
          <svg className="db-select-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <svg className="db-select-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .db-search-wrap input::placeholder {
    color: #c4bcda;
  }
